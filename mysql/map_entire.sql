...
CREATE TABLE IF NOT EXISTS `mppt` (
  ...
  `Temp_Int` tinyint(3) NOT NULL,
  `Temp_Bat` tinyint(3) NOT NULL,
...
INSERT INTO `sms_alert` (`number`, `field`, `le`, `ge`, `sms`) VALUES
(1, '_Uacc', 47.00, 58.20, 'ACC is out of range'),
(2, '_Temp_Grad0', 6.00, 28.00, 'Temp is out of range                               '),
(3, '_UOUTmed', 100.00, 100.00, 'No output 220V                          ');
COMMIT;
