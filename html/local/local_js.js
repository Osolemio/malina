...
'alert1':'Счетчик сброшен',
'alert2':'Ошибка получения данных',
...
var 
    map_mode=["МАП выключен и нет сети на входе","МАП выключен. Сеть на входе","МАП включен. Генерация от АКБ. Нет сети.","МАП включен и транслирует сеть","МАП включен. Трансляция + заряд","","","","","",
