...
echo $row[0x01][1]^0xC0; if ($row[0x01][1]&0x80) echo $text['HYBRID']; echo "|";
...
if ($row[0x51][1]&1) echo $text['env'].",";if ($row[0x51][1]&2) echo " ".$text['tor'].","; if ($row[0x51][1]&1) echo " ".$text['transistors']."."; echo "|";
echo $row[0x52][1]; echo "|";
$i=$row[0x65][1]/100; echo $i."C"; echo "|";
echo $row[0x66][1]." ".$text['min']; echo "|";
echo $row[0x68][1]."% ".$text['from_max']; echo "|";
echo $row[0x73][1]; echo "|";
echo $row[0x78][1]." ".$text['sec']; echo "|";
echo $row[0x7B][1]." ".$text['sec']; echo "|";
echo $row[0x7E][1]." ".$text['min']; echo "|";
echo $row[0x7F][1]." ".$text['min']; echo "|";
echo $row[0x80][1]." ".$text['sec']; echo "|";
