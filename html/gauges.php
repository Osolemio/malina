...
<div id="map">
    ...
    <div id="meter_o"><div id="text_v">0</div><div id="input1" onmouseover="tooltip(this,'Вход 1. Оранж-нет сети')" onmouseout="hide_info(this)">
    </div><div id="input2" onmouseover="tooltip(this,'Вход 2. Оранж-нет сети')" onmouseout="hide_info(this)"></div>
