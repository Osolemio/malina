...
<div id='text_battery_ah' style='color:white; top:140px; left:10px; font-size:120%; font-weight:700;'>".$text['NA']."</div>
<div id='text_battery_percent' style='color:white; top:100px; left:10px; font-size:120%; font-weight:700;'>".$text['NA']."</div>
<div id='text_battery_cons' style='color:white; top:140px; left:150px; font-size:120%; font-weight:700;'>".$text['NA']."</div>
...
<?php
	...
	<div id='text_map_vin".$index."' class='text_map_vin'>".$text['na']."</div>
	<div id='text_map_vout".$index."' class='text_map_vout'>".$text['na']."</div>
	<div id='text_map_inet".$index."' class='text_map_inet'>".$text['na']."</div>
	<div id='text_map_fin".$index."' class='text_map_fin'>".$text['na']."</div>
	<div id='text_map_fout".$index."' class='text_map_fout'>".$text['na']."</div>
	<div id='text_map_pnet".$index."' class='text_map_pnet'>".$text['na']."</div>
	<div id='text_map_pacc".$index."' class='text_map_pacc'>".$text['na']."</div>
	<div id='text_map_iacc".$index."' class='text_map_iacc'>".$text['na']."</div>
	<div id='text_map_psumm".$index."' class='text_map_psumm'>".$text['na']."</div>
	<div id='text_map_pi2c".$index."' class='text_map_pi2c'>".$text['na']."</div>
	<div id='text_map_ii2c".$index."' class='text_map_ii2c'>".$text['na']."</div>
	<div id='text_map_temp".$index."' class='text_map_temp'>".$text['na']."</div>
	...
	<div id='map_vacc".$index."' style='color:white; font-size:120%; font-weight:700; text-align:center; background-color:#000013; width:60px; height:30px; top:500px; left:".(($n-1)*208+140)."px;'>".$text['na']."</div>
	<div id='map_acc_temp".$index."' style='color:white; font-size:120%; font-weight:700; text-align:center; background-color:#000013; width:50px; height:30px; top:500px; left:".(($n-1)*208+20)."px;'>".$text['na']."</div>";
	}
	...
	<div id='text_mppt_mode".$index."' class='text_mppt_mode'>".$text['na']."</div>
	<div id='text_mppt_vpv".$index."' class='text_mppt_vpv'>".$text['na']."</div>
	<div id='text_mppt_wind".$index."' class='text_mppt_wind'>".$text['na']."</div>
	<div id='text_mppt_ipv".$index."' class='text_mppt_ipv'>".$text['na']."</div>
	<div id='text_mppt_ppv".$index."' class='text_mppt_ppv'>".$text['na']."</div>
	<div id='text_mppt_temp".$index."' class='text_mppt_temp'>".$text['na']."</div>
	<div id='text_mppt_counter".$index."' class='text_mppt_counter'>".$text['na']."</div>
	<div id='text_mppt_pacc".$index."' class='text_mppt_pacc'>".$text['na']."</div>
	...
	<div id='mppt_vacc".$index."' style='color:white; font-size:120%; font-weight:700; text-align:center; background-color:#000013; width:60px; height:30px; top:500px; left:".(($n-1)*208+140)."px;'>".$text['na']."</div>
	<div id='mppt_acc_temp".$index."' style='color:white; font-size:120%; font-weight:700; text-align:center; background-color:#000013; width:50px; height:30px; top:500px; left:".(($n-1)*208+20)."px;'>".$text['na']."</div>";
    }
