<?php
 ...
 $settings=array(
    ...
    array(1,3,0x153,null,'dc',$row[0x153+8]['value'],$row[0x153+16]['value'],
       $row[0x153]['value'],(($row[0x153+8]['value']==$row[0x153+16]['value']) || $row[0x153]['value']==255)?'off':'on'), 
    array(1,4,0x155,null,'number',$row[0x155+8]['value'],$row[0x155+16]['value'],
       $row[0x155]['value'],(($row[0x155+8]['value']==$row[0x155+16]['value']) || $row[0x155]['value']==255)?'off':'on'), 
    array(1,5,0x156,null,'list',$row[0x156+8]['value'],$row[0x156+16]['value'],
       $row[0x156]['value'],(($row[0x156+8]['value']==$row[0x156+16]['value']) || $row[0x156]['value']==255)?'off':'on'), 
    array(1,6,0x157,null,'number',$row[0x157+8]['value'],$row[0x157+16]['value'],
